<header class="app-header navbar">
    ...
    <a class="navbar-brand" href="#">
        <img class="navbar-brand-full" src="https://coreui.io/docs/assets/brand/logo.svg" alt="CoreUI Logo" width="89" height="25">
        <img class="navbar-brand-minimized" src="https://coreui.io/demo/img/brand/sygnet.svg" alt="CoreUI Logo" width="30" height="30">
    </a>
    ...
    <ul class="nav navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown">
            <a class="nav-link nav-link" data-toggle="dropdown" href="#" role="button" aria-haspopup="true"
                aria-expanded="false">
                <img class="img-avatar" src="https://api.adorable.io/avatars/55/{{ str_slug(Auth::user()->first_name. ' '.Auth::user()->last_name) }}.png" alt="{{ Auth::user()->first_name }} {{ Auth::user()->last_name }}">
            </a>
